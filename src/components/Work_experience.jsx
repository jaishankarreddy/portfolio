...
const Work_experience = () => {
  ...
  return (
    ...
    >
      <h2
        className="text-3xl font-bold items-center justify-center my-5 sm:my-7 mb-10 flex gap-2 sm:gap-3 sm:text-5xl"
      ...
      <div className="relative">
        ...
        {[
          ...
          },
          {
            ...
            dotColor: "bg-gray-400",
            discription:
              "Completed a MERN Stack internship, building interactive web applications using MongoDB, Express.js, React.js, and Node.js.",
          },
        ].map((experience, index) => (
          <div
            key={index}
            className="flex mb-2 sm:mb-12 items-center"
            ref={(el) => el && divs.current.push(el)}
          >
            <div className="work_left w-1/2 pr-8 text-right">
              <h3 className=" work_company font-bold text-2xl mr-5">
                {experience.company}
              </h3>
